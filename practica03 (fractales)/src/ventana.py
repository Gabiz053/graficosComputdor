...
class Ventana(ABC):
    ...
    def _crear_ventana(self) -> ctk.CTk:
        ...
        La ventana se coloca centrada en la pantalla y pegada a la parte superior.
        ...
        # Calcular la posición x e y para centrar la ventana y pegarla arriba
        x_position = (screen_width - window_width // 2) // 2  # Centrado horizontal
        y_position = 0  # Pegada a la parte superior
