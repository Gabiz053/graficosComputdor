...
# Imports locales
from src.constantes import Default
from src.algoritmos_dibujo import AlgoritmoDibujo
from src.ventana_menu_canvas_animacion import VentanaMenuCanvasAnimacion
